    ...
    <link rel="stylesheet" href="css/purchaseReport.css" type="text/css">
     <script>
        function updateCartItem(obj,id){
            $.get("rentcartAction.php", {action:"updateCartItem", id:id, qty:obj.value}, function(data){
                if(data == 'ok'){
                    location.reload();
                }else{
...
<div class="container">
    ...
    <tfoot>
        <tr>
            <td><a href="rent.php" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i> Continue Shopping</a></td>
            <td colspan="2"></td>
